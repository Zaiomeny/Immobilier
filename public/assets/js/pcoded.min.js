            ...
            function closeSubMenu() {
                $(document).on('click', function (evt) {
                    ...
                    if (!target.parents('.pcoded-item').length) {
                        if (sdt != "phone") {
                            if (vnt != "expanded") {
                                // Uncomment the following part of code if you want the submenu to be displayed after toggling the sidebar
            ...
            switch (settings.MenuTrigger) {
                ...
                case 'click':
                    ...
                    $(".pcoded-item > li ").on('click', function () {
                        /** uncomment this script if you like the behavior when you click on an item of sidebar menu, all of the other menu with childs items toggle all of their childs items
                        if ($(this).hasClass('pcoded-trigger')) {
                            $(this).removeClass('pcoded-trigger');
                        } else {
                            $(this).closest('.pcoded-inner-navbar').find('li.pcoded-trigger').removeClass('pcoded-trigger');
